<script lang="ts">
	...
	const shareModelHandler = async (model) => {
		toast.success($i18n.t('Redirecting you to Prosper Chat Community'));
			...
			>
				<div class="flex gap-4 mt-1 mb-0.5">
					<div class=" w-10">
						...
						>
							<img
								src={model?.meta?.profile_image_url ?? `${WEBUI_BASE_URL}/static/static/favicon.png`}
	...
	{#if $config?.features.enable_community_sharing}
		<div class=" my-16">
			<div class=" text-xl font-medium mb-1 line-clamp-1">
				{$i18n.t('Made by Prosper Chat Community')}
			</div>
