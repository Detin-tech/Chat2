...
frontend_favicon = FRONTEND_BUILD_DIR / "static" / "static/favicon.png"

if frontend_favicon.exists():
    try:
        shutil.copyfile(frontend_favicon, STATIC_DIR / "static/favicon.png")
    except Exception as e:
        logging.error(f"An error occurred: {e}")

frontend_splash = FRONTEND_BUILD_DIR / "static" / "static/favicon.png"

if frontend_splash.exists():
    try:
        shutil.copyfile(frontend_splash, STATIC_DIR / "static/favicon.png")
    except Exception as e:
        logging.error(f"An error occurred: {e}")
...
if ENV == "prod":
    if OLLAMA_BASE_URL == "/ollama" and not K8S_FLAG:
        if USE_OLLAMA_DOCKER.lower() == "true":
            # if you use all-in-one docker container (Prosper Chat + Ollama)
...
DEFAULT_ARENA_MODEL = {
    ...
    "name": "Arena Model",
    "meta": {
        "profile_image_url": "/static/static/favicon.png",
