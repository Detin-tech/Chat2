...
from open_webui.routes.api import sync_batch
...
app.state.OWUI_AUTH_TOKEN = OWUI_AUTH_TOKEN
...
app.state.config.FILE_ASYNC_THRESHOLD = RAG_FILE_ASYNC_THRESHOLD
...
# Vision Router defaults
app.state.config.VISION_ROUTER_ENABLED = VISION_ROUTER_ENABLED
app.state.config.VISION_ROUTER_MODE = VISION_ROUTER_MODE
app.state.config.VISION_ROUTER_MODEL = VISION_ROUTER_MODEL
app.state.config.VISION_ROUTER_SKIP_MODELS = VISION_ROUTER_SKIP_MODELS
app.state.config.VISION_ROUTER_ENABLE_ADMINS = VISION_ROUTER_ENABLE_ADMINS
app.state.config.VISION_ROUTER_ENABLE_USERS = VISION_ROUTER_ENABLE_USERS
app.state.config.VISION_ROUTER_SHOW_STATUS_EVENTS = VISION_ROUTER_SHOW_STATUS_EVENTS
...
app.include_router(sync_batch.router, prefix="/api/internal", tags=["sync-batch"])
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Prosper Chat.
...
async def get_opensearch_xml():
    ...
    <Image width="16" height="16" type="image/x-icon">{app.state.config.WEBUI_URL}/static/favicon_new.png</Image>
...
def swagger_ui_html(*args, **kwargs):
    return get_swagger_ui_html(
        ...
        **kwargs,
        ...
        swagger_favicon_url="/static/favicon_new.png",
    )
